...
The 5% direct default split looks small. But the math closes — if the app also stakes on its own project — through three simultaneous vectors:

### (A) Direct rebate

5% of every payment. Instant, in CREDIT. The operational cash flow.

### (B) Emission via stake on its own `projectId`
...
- (A) Direct rebate: 5% × 600k = **30,000 CREDIT** instant.
- In round R, `projectShare_ChatApp = 902,500 × 600k/950k = 570,000 CREDIT`.
- If ChatApp staked 50k GOV with a 365d lock (4x multiplier, 200k weight), and total weight in the project is 400k, it captures 50% × 570k = **285,000 CREDIT**.
...
### (C) Appreciation of retained CREDIT
...
## When (B) does not close the math

Apps without capital to acquire GOV cannot capture (B). For those cases:

- The default split (95/0/5) may be **disincentivising**.
